...
class Decoder:
    ...
    def caesar(self, secret_message, key):
        ...
        for index in range(number_of_divisions):
            ...
            threads_list.append(threading.Thread(target=self.__caesar_decrypter, args=(splitted_secret_message[index], key, que)))
    ...
    def vigenere(self, secret_message, key):
        ...
        for index in range(number_of_divisions):
            ...
            secret_message = secret_message[division_sentinel:]
            threads_list.append(threading.Thread(target=self.__vigenere_decrypter, args=(splitted_message[index], key, que)))
